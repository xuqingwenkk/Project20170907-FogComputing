...
namespace MultiColSLAM
{
	...
	class cLocalMapping;
	class cLoopClosing;
	class cMultiCamSys_; //cam_system_omni.h
	class cViewer;
	...
	public:
		...
		cv::Matx44d TrackMultiColSLAM(const fog_msgs::Features& features, const double &timestamp);
		cv::Matx44d TrackMultiColSLAM(const cv::Mat& descriptors,
									  const cv::Mat& masks,
