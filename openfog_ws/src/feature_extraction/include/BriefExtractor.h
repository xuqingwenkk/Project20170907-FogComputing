...
#ifndef OmniSLAM_BRIEFEXTRACTOR_H
#define OmniSLAM_BRIEFEXTRACTOR_H
...
namespace OmniSLAM{
    ...
    public:
        ...
        int inline GetLevels(){ return num_levels_; }

        double inline GetScaleFactor() { return scale_factor_; }

        bool GetMasksLearned() { return learn_masks_; }
        int GetDescriptorSize() { return desc_size_; }
    ...
    protected:
        ...
        std::vector<int> mn_features_per_level_;

        std::vector<int> umax_;

        std::vector<double> mv_scale_factor_;
        std::vector<double> mv_inv_scale_factor_;

        std::vector<cv::Mat> mv_image_pyramid_;
        std::vector<cv::Mat> mv_mask_pyramid_;

    };
}

#endif //PROJECT_BRIEFEXTRACTOR_H
